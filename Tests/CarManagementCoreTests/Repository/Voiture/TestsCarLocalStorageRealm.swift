...
final class TestsCarLocalStorageRealm: XCTestCase {
    ...
    func createLocalStorage() async -> CarStorageProtocol { try! await () }

    func createValue() -> CarDTO { .init(carId: firstCarId, id: .init(), title: "title1", mileage: 1, cost: 1, date: .now, type: .maintenance) }
